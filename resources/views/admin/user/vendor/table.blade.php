                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <a href="/vendor/create" class="btn btn-primary">Add+</a>
                                        </div>
                                    </div>
...
<tr>
                                                        ...
                                                        <td>{{ $tables->location }}</td>
                                                         <td>{{ $tables->phone }}</td>
                                                        <td>{{ $tables->email }}</td>
                                                        {{-- <td><a href="{{ route('vendor.view',[$tables->_id]) }}" class="btn btn-primary">View</a></td> --}}

                                                        {{-- <td><a href="{{ route('vendor.view',[$tables->_id]) }}" class="btn btn-primary">view</a></td> --}}

                                                        <td>@if ($tables->isActive == 1)
                                                           <a href="{{ route('vendor.deactive',[$tables->_id]) }}" class="btn btn-danger">Deactivate</a>
                                                           @else
                                                           <a href="{{ route('vendor.active',[$tables->_id]) }}" class="btn btn-success">Activate</a>
                                                        @endif</td>
                                                        <td><a href="{{ route('vendor.edit',[$tables->_id]) }}" class="btn btn-primary">Edit</a></td>
                                                        <td><a href="{{ route('vendor.delete',[$tables->_id]) }}" class="btn btn-primary">Delete</a></td>
</tr>
                                                          @endforeach
