...
<tr>
                                                        ...
                                                        <td>@if ($tables->status == 1)
                                                           <a href="{{ route('preport.initatecc',[$tables->_id]) }}" class="btn btn-warning">Initated</a>
                                                           @elseif ($tables->status == 2)
                                                           <a href="{{ route('preport.processcc',[$tables->_id]) }}" class="btn btn-warning">Processing</a>
                                                            @elseif ($tables->status == 3)
                                                           <a href="{{ route('preport.approvecc',[$tables->_id]) }}" class="btn btn-success">Approved</a>
                                                           @elseif ($tables->status == 4)
                                                           <a href="{{ route('preport.rejectcc',[$tables->_id]) }}" class="btn btn-danger">Rejected</a>
