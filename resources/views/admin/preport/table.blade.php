...
<tr>
                                                        ...
                                                        <td>@if ($tables->status == 1)
                                                           <a href="{{ route('preport.initate',[$tables->_id]) }}" class="btn btn-warning">Initated</a>
                                                           @elseif ($tables->status == 2)
                                                           <a href="{{ route('preport.process',[$tables->_id]) }}" class="btn btn-warning">Processing</a>
                                                            @elseif ($tables->status == 3)
                                                           <a href="{{ route('preport.approve',[$tables->_id]) }}" class="btn btn-success">Approved</a>
                                                           @elseif ($tables->status == 4)
                                                           <a href="{{ route('preport.reject',[$tables->_id]) }}" class="btn btn-danger">Rejected</a>
