...
<tr>
                                                        ...
                                                        <td>@if ($tables->status == 1)
                                                           <a href="{{ route('preport.initateonboarding',[$tables->_id]) }}" class="btn btn-warning">Initated</a>
                                                           @elseif ($tables->status == 2)
                                                           <a href="{{ route('preport.processonboarding',[$tables->_id]) }}" class="btn btn-warning">Processing</a>
                                                            @elseif ($tables->status == 3)
                                                           <a href="{{ route('preport.approveonboarding',[$tables->_id]) }}" class="btn btn-success">Approved</a>
                                                           @elseif ($tables->status == 4)
                                                           <a href="{{ route('preport.rejectonboarding',[$tables->_id]) }}" class="btn btn-danger">Rejected</a>
