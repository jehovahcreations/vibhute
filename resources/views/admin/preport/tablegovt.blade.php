                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-xl-6">
                                           <h4 class="card-title">Govt Services</h4>
                                        </div>
                                        <div class="col-xl-6">
...
<tr>
                                                        ...
                                                        <td>@if ($tables->status == 1)
                                                           <a href="{{ route('preport.initategovt',[$tables->_id]) }}" class="btn btn-warning">Initated</a>
                                                           @elseif ($tables->status == 2)
                                                           <a href="{{ route('preport.processgovt',[$tables->_id]) }}" class="btn btn-warning">Processing</a>
                                                            @elseif ($tables->status == 3)
                                                           <a href="{{ route('preport.approvegovt',[$tables->_id]) }}" class="btn btn-success">Approved</a>
                                                           @elseif ($tables->status == 4)
                                                           <a href="{{ route('preport.rejectgovt',[$tables->_id]) }}" class="btn btn-danger">Rejected</a>
