                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-xl-6">
                                           <h4 class="card-title">Disclimer</h4>
                                        </div>
                                        <div class="col-xl-6">
                                            <a href="/disclimer/create" class="btn btn-primary">Add+</a>
                                        </div>
                                    </div>
...
<tr>
                                                        ...
                                                        <td>@if ($tables->is_Active == 1)
                                                           <a href="{{ route('disclimer.deactive',[$tables->_id]) }}" class="btn btn-danger">Deactivate</a>
                                                           @else
                                                           <a href="{{ route('disclimer.active',[$tables->_id]) }}" class="btn btn-success">Activate</a>
                                                        @endif</td>
                                                        <td><a href="{{ route('disclimer.edit',[$tables->_id]) }}" class="btn btn-primary">Edit</a></td>
                                                        <td><a href="{{ route('disclimer.delete',[$tables->_id]) }}" class="btn btn-primary">Delete</a></td>
</tr>
                                                          @endforeach
