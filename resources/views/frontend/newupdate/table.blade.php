                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <a href="/newupdate/create" class="btn btn-primary">Add+</a>
                                        </div>
                                    </div>
...
<tr>
                                                        ...
                                                        <td>@if ($tables->is_Active == 1)
                                                           <a href="{{ route('newupdate.deactive',[$tables->_id]) }}" class="btn btn-danger">Deactivate</a>
                                                           @else
                                                           <a href="{{ route('newupdate.active',[$tables->_id]) }}" class="btn btn-success">Activate</a>
                                                        @endif</td>
                                                        <td><a href="{{ route('newupdate.edit',[$tables->_id]) }}" class="btn btn-primary">Edit</a></td>
                                                        <td><a href="{{ route('newupdate.delete',[$tables->_id]) }}" class="btn btn-primary">Delete</a></td>
</tr>
                                                          @endforeach
