...
<tr>
                                                        ...
                                                        <td>@if ($tables->is_Active == 1)
                                                           <a href="{{ route('banner.deactive',[$tables->_id]) }}" class="btn btn-danger">Deactivate</a>
                                                           @else
                                                           <a href="{{ route('banner.active',[$tables->_id]) }}" class="btn btn-success">Activate</a>
                                                        @endif</td>
                                                        <td><a href="{{ route('banner.edit',[$tables->_id]) }}" class="btn btn-primary">Edit</a></td>
