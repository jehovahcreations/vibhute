                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <a href="/comboexpert/create" class="btn btn-primary">Add+</a>
                                        </div>
                                    </div>
...
<tr>
                                                        ...
                                                        <td>@if ($tables->is_Active == 1)
                                                           ...
                                                           @else
                                                           <a href="{{ route('comboexpert.active',[$tables->_id]) }}" class="btn btn-success">Activate</a>
                                                        @endif</td>
                                                        {{-- <td><a href="{{ route('comboexpert.edit',[$tables->_id]) }}" class="btn btn-primary">Edit</a></td> --}}
                                                        <td><a href="{{ route('comboexpert.delete',[$tables->_id]) }}" class="btn btn-primary">Delete</a></td>
</tr>
                                                          @endforeach
